...
export default function VoiceAgentsError({ reset }: ErrorProps) {
  return (
    <div className="p-6 sm:p-8 max-w-5xl mx-auto text-center py-20">
      ...
      <div className="flex items-center justify-center gap-4">
        <button onClick={reset} className="text-sm text-accent hover:text-accent/80 font-medium transition-colors">
          Try again
        </button>
